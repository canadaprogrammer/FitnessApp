...
struct CountDown {
    ...
    // test mode
    init(rounds: Int = 3, warmUp: timeInput = timeInput(minutes: 0, seconds: 05), work: timeInput = timeInput(minutes: 0, seconds: 05), rest: timeInput = timeInput(minutes: 0, seconds: 05), coolDown: timeInput = timeInput(minutes: 0, seconds: 05), remainingTime: Int = 0) {
